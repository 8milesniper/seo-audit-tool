...
const AuditDashboard = () => {
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send lead via email using Formspree (temporary solution)
      await fetch('https://formspree.io/f/xnnqkqwd', {
        method: 'POST',
        headers: {
...
This lead was captured from: https://3y4yfdsyun.space.minimax.io
          `,
